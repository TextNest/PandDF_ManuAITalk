# ============================================================
#  File: module/rag_pipeline/figure_chunker.py
# ============================================================
# [모듈 개요]
...
#   - CHUNKS_ROOT_DIR  : PROJECT_ROOT / "data" / "chunks"
#
# [사용 예시] (Full/Backend에서 실행)
#   - 전체 문서에 대해 figure 청크 생성:
#       (.venv) > python -m module.rag_pipeline.figure_chunker
#
#   - 특정 문서만 처리 (예: SAH001):
#       (.venv) > python -m module.rag_pipeline.figure_chunker --doc-id SAH001
#
#   - 기존 figure 청크를 무시하고 다시 생성:
#       (.venv) > python -m module.rag_pipeline.figure_chunker --force
#
# ============================================================
...
# 이 파일(module/rag_pipeline/figure_chunker.py)을 기준으로 Backend 루트 계산
#   .../Full/Backend/module/rag_pipeline/figure_chunker.py
