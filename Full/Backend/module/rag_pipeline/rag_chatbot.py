# ============================================================
#  File: module/rag_pipeline/rag_chatbot.py
# ============================================================
# [모듈 개요]
...
# [실행 예]
#   (Backend 루트에서)
#   (.venv) PS C:\Users\user\Desktop\project\PandDF_ManuAITalk\Full\Backend> \
#       python -m module.rag_pipeline.rag_chatbot
#
# ============================================================
...
if __name__ == "__main__":
    # python -m module.rag_pipeline.rag_chatbot  으로 실행될 때의 진입점
    try:
        main()
