# ============================================================
#  File: module/rag_pipeline/image_filter_for_caption.py
# ============================================================
# [모듈 개요]
...
#
#   - 이후 이미지 캡셔닝 스크립트(예: image_captioner_gemini.py 등)에서
...
#
# [사용 예] (Full/Backend 폴더에서 실행한다고 가정)
#   - 모든 문서에 대해 필터링:
#       (.venv) > python -m module.rag_pipeline.image_filter_for_caption
#
#   - 특정 문서만 필터링 (예: SIF-20FLY):
#       (.venv) > python -m module.rag_pipeline.image_filter_for_caption --doc-id SIF-20FLY
#
#   - 기존 *_figures_filtered.json 덮어쓰기:
#       (.venv) > python -m module.rag_pipeline.image_filter_for_caption --force
# ============================================================
...
# 이 파일(module/rag_pipeline/image_filter_for_caption.py)을 기준으로 Backend 루트 계산
#   .../Full/Backend/module/rag_pipeline/image_filter_for_caption.py
