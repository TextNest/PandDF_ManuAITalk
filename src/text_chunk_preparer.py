# ============================================================
#  File: src/text_chunk_preparer.py
# ============================================================
# [모듈 개요]
...
#       (.venv) > python -m src.text_chunk_preparer
#
#   - 특정 문서만 처리 (예: SAH001):
#       (.venv) > python -m src.text_chunk_preparer --doc-id SAH001
#
#   - 기존 normalized 결과를 무시하고 다시 생성:
#       (.venv) > python -m src.text_chunk_preparer --force
#
# ============================================================
...
# 이 파일(src/text_chunk_preparer.py)을 기준으로 프로젝트 루트 계산
